...
from src.use_case.rendez_vous.annuler_rendez_vous import AnnulerRendezVous
...
class TestMain(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.clore_rendez_vous = AnnulerRendezVous(rendez_vous_repository)

    def test_clore_rendez_vous(self) -> None:
        rdv_id = 1
        output_rdv = self.clore_rendez_vous.execute(rdv_id)
        self.assertEqual(output_rdv.statut, Statut.ANNULE)
